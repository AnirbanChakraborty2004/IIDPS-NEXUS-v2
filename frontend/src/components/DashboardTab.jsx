  ...
  return (
    <>
      ...
      <div className="md:hidden">
        ...
        {/* ── FULL VIEWPORT HERO ──
            Escapes the App's px-4 container with negative margins.
            100svh = full visible screen height on mobile browsers.        */}
        <div style={{
          position:       'relative',
          width:          '100vw',
          height:         '100svh',
          marginLeft:     '-1rem',   /* cancel App px-4 left  */
          marginTop:      '-0.5rem', /* cancel App pt-2 top   */
          overflow:       'hidden',
          flexShrink:      0,
        }}>
          <div style={{
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {/* <div className="grid grid-cols-2 gap-4">
            ...
            <div className="glass-panel p-4">
              ...
              <div className="text-2xl font-black font-mono text-red-500">3</div>
            </div>
            <div className="glass-panel p-4">
          ...
          <div className="glass-panel flex-1">
            ...
            <div className="flex flex-col gap-3">
              {mockAlerts.map((alert, idx) => (
                <div key={idx} className="flex justify-between items-center bg-black/40 p-3 rounded-lg border border-white/5 gap-2">
                  <div className="flex items-center gap-3">
                    <div className={`w-2.5 h-2.5 rounded-full ${
                      alert.color==='red'    ? 'bg-red-500 shadow-[0_0_8px_#ef4444]' :
                      alert.color==='orange' ? 'bg-orange-500 shadow-[0_0_8px_#f97316]' :
                                               'bg-yellow-500 shadow-[0_0_8px_#eab308]'}`} />
                    <span className="text-sm text-gray-200">
                      {alert.type} from <span className="font-mono text-gray-400">{alert.source}</span>
